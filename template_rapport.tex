...
% ========== Classe du document ==========
\documentclass[a4paper,10pt]{report}    % A4, police taille 11, report pour avoir les chapitres, fleqn pour avoir les équations alignées à gauche
...
\newpage
%\input{Chapitre/nomenclature.tex}
\section*{Remerciements}
\setcounter{page}{1}
\input{Chapitre/chap1.tex}
\input{Chapitre/chap2.tex}
%\input{Chapitre/chap3.tex}
% ======================================== Fin Document ========================================
...
\printbibliography
\appendix
%\input{Annexes/analytique.tex}
%\input{Annexes/coefficient_gradient.tex}
%\input{Annexes/parametrage.tex}
%\input{Annexes/stab_phases.tex}
%\input{Annexes/deroul_acc.tex}
